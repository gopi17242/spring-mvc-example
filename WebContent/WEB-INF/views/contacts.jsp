...
<head>
 <link rel="stylesheet" type="text/css" media="screen" href="/spring-mvc-example/resources/css/jquery/ui-lightness/jquery-ui-1.8.6.custom.css" />
 <link rel="stylesheet" type="text/css" media="screen" href="/spring-mvc-example/resources/css/jqgrid/ui.jqgrid.css" />
 
 <script type="text/javascript" src="/spring-mvc-example/resources/js/jquery/jquery-1.4.4.min.js"></script>
 <script type="text/javascript">
     var jq = jQuery.noConflict();
 </script>
 <script type="text/javascript" src="/spring-mvc-example/resources/js/jquery/jquery-ui-1.8.6.custom.min.js"></script> 
 <script type="text/javascript" src="/spring-mvc-example/resources/js/jqgrid/grid.locale-en.js" ></script>
 <script type="text/javascript" src="/spring-mvc-example/resources/js/jqgrid/jquery.jqGrid.min.js"></script>
...
<script type="text/javascript">
 jq(function() {
  jq("#grid").jqGrid({
      url:'/spring-mvc-example/contacts',
   datatype: 'json',
   mtype: 'GET',
